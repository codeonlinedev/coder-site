...
"updateProfileV2": "done.invoke.authState.signedIn.profile.updatingProfileV2:invocation[0]";
        ...
        eventsCausingActions: {
          "assignData": "done.invoke.authState.loadingInitialAuthData:invocation[0]" | "done.invoke.signIn" | "done.invoke.signInWithGoogle";
"assignError": "error.platform.authState.loadingInitialAuthData:invocation[0]" | "error.platform.signIn" | "error.platform.signInWithGoogle" | "error.platform.signOut";
...
"clearError": "SIGN_IN" | "SIGN_IN_WITH_GOOGLE" | "done.invoke.authState.loadingInitialAuthData:invocation[0]" | "done.invoke.signOut";
